...
/// <summary>
///     Defines the structure of a reinforcement learning environment that uses discrete actions.
/// </summary>
/// <typeparam name="TState">The type that describes the state of the environment.</typeparam>
public interface IDiscreteEnvironment<TState> : IEnvironment<TState>
