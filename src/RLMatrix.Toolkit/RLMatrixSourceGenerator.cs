...
public class RLMatrixSourceGenerator : IIncrementalGenerator
{
    ...
    private static bool HasContinuousActions(INamedTypeSymbol classSymbol)
    {
    ...
    private static void ReportDiagnostic(SourceProductionContext context, ClassDeclarationSyntax classDeclaration, string id, string message)
    {
    ...
    private static void GenerateRLInitMethod(StringBuilder sb, EnvironmentInfo info)
    {
        var returnType = info.EnvironmentType.Name;
    ...
    private static void GenerateInitializeObservationsMethod(StringBuilder sb, EnvironmentInfo info)
    {
    ...
    private static void GenerateIsHardDoneMethod(StringBuilder sb, EnvironmentInfo info)
    {
    ...
    private static void GenerateIsSoftDoneMethod(StringBuilder sb)
    {
    ...
    private static void GenerateGhostStepMethod(StringBuilder sb, EnvironmentInfo info)
    {
    ...
    private static void GenerateGetAllObservationsMethod(StringBuilder sb, EnvironmentInfo info)
    {
    ...
    private static void GenerateGetBaseObservationsMethod(StringBuilder sb, EnvironmentInfo info)
    {
